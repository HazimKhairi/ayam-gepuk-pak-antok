...
expect {
    ...
    "root@*" {
        ...
        send "echo '=== Run update script ==='\r"
        expect "root@*"

        send "DATABASE_URL='mysql://agpa_user:Agpa2026!@localhost:3306/ayamgepuk' npm run update:sets\r"
        set timeout 120
        expect "root@*"
        ...
        send "echo '=== Verify all sets have customization ==='\r"
        expect "root@*"
